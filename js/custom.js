...
function scroll_top(){
	...
	var $dzScrollToTop = '<button id="dzScrollToTop" class="scroltop fa fa-arrow-up" ></button>';
	if($("#dzScrollToTop").length == 0) {
		jQuery('body').append($dzScrollToTop);
	}
...
{
	var dzSwitcher = '<div class=styleswitcher><div class=switcher-btn-bx><a class=switch-btn><span class="fa fa-gear fa-lg fa-spin"></span></a></div><div class=styleswitcher-inner><h6 class=switcher-title>Layout</h6><ul class=layout-view><li class="active wide-layout">Wide<li class=boxed>Boxed</ul><h6 class=switcher-title>Nav</h6><ul class=nav-view><li class="active nav-light">Light<li class=nav-dark>Dark</ul><h6 class=switcher-title>Header</h6><ul class=header-view><li class="active header-fixed">Fixed<li class=header-static>Static</ul><h6 class=switcher-title>Color Skin</h6><ul class=color-skins><li><a class="theme-skin skin-1"href="?theme=css/skin/skin-1"title="default Theme"></a><li><a class="theme-skin skin-2"href="?theme=css/skin/skin-2"title="pink Theme"></a><li><a class="theme-skin skin-3"href="?theme=css/skin/skin-3"title="sky Theme"></a><li><a class="theme-skin skin-4"href="?theme=css/skin/skin-4"title="green Theme"></a><li><a class="theme-skin skin-5"href="?theme=css/skin/skin-5"title="red Theme"></a><li><a class="theme-skin skin-6"href="?theme=css/skin/skin-6"title="orange Theme"></a><li><a class="theme-skin skin-7"href="?theme=css/skin/skin-7"title="purple Theme"></a><li><a class="theme-skin skin-8"href="?theme=css/skin/skin-8"title="blue Theme"></a></ul><h6 class=switcher-title>Background Image</h6><ul class=background-switcher><li><img alt=""rel=images/background/bg1.webp src=images/switcher/switcher-bg/bg1.webp><li><img alt=""rel=images/background/bg2.webp src=images/switcher/switcher-bg/bg2.webp><li><img alt=""rel=images/background/bg3.webp src=images/switcher/switcher-bg/bg3.webp><li><img alt=""rel=images/background/bg4.webp src=images/switcher/switcher-bg/bg4.webp></ul><h6 class=switcher-title>Background Pattern</h6><ul class=pattern-switcher><li><img alt=""rel=images/pattern/pt1.webp src=images/switcher/switcher-patterns/bg1.webp><li><img alt=""rel=images/pattern/pt2.webp src=images/switcher/switcher-patterns/bg2.webp><li><img alt=""rel=images/pattern/pt3.webp src=images/switcher/switcher-patterns/bg3.webp><li><img alt=""rel=images/pattern/pt4.webp src=images/switcher/switcher-patterns/bg4.webp><li><img alt=""rel=images/pattern/pt5.webp src=images/switcher/switcher-patterns/bg5.webp><li><img alt=""rel=images/pattern/pt6.webp src=images/switcher/switcher-patterns/bg6.webp><li><img alt=""rel=images/pattern/pt7.webp src=images/switcher/switcher-patterns/bg7.webp><li><img alt=""rel=images/pattern/pt8.webp src=images/switcher/switcher-patterns/bg8.webp><li><img alt=""rel=images/pattern/pt9.webp src=images/switcher/switcher-patterns/bg9.webp><li><img alt=""rel=images/pattern/pt10.webp src=images/switcher/switcher-patterns/bg10.webp><li><img alt=""rel=images/pattern/pt11.webp src=images/switcher/switcher-patterns/bg11.webp><li><img alt=""rel=images/pattern/pt12.webp src=images/switcher/switcher-patterns/bg12.webp></ul></div></div>';
